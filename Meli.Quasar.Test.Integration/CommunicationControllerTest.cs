...
namespace Meli.Quasar.Test.Integration
{
    ...
    public class CommunicationControllerTest
    {
        ...
        public CommunicationControllerTest(ServerFixture server)
        {
            _server = server;
        }
        ...
        {
            var satoSateliteSplitDto = new SatelliteSplitRequestDto(142.7, new List<string> { "este", "", "un", "", "" });
            var kenobiSateliteSplitDto = new SatelliteSplitRequestDto(100.0, new List<string> { "este", "", "", "mensaje", "" });
            var skywalkerSateliteSplitDto = new SatelliteSplitRequestDto(115.5, new List<string> { "", "es", "", "", "secreto" });
            ...
            responseKenobi.StatusCode.Should().Be(StatusCodes.Status201Created);
            responseSato.StatusCode.Should().Be(StatusCodes.Status201Created);
            responseSkywalker.StatusCode.Should().Be(StatusCodes.Status201Created);
